...
#' Gradient of the Wiener diffusion cumulative distribution function
#' 
#' Calculate the gradient of the Wiener diffusion cumulative distribution function.
...
#'   \itemize{
#'     \item \code{deriv}: a \code{data.frame} containing the derivatives of the CDF with respect to a, v, and w,
#'     \item \code{derivln}: a \code{data.frame} containing the derivatives of the log-transformed CDF with respect to a, v, and w, 
