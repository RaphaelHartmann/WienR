...
#' Partial derivative of the Wiener diffusion cumulative distribution function with respect to the drift rate
#'
#' Calculate the partial derivative of the Wiener diffusion cumulative distribution function with respect to the drift rate v.
...
#'   \itemize{
#'     \item \code{deriv}: the derivatives of the CDF with respect to v,
#'     \item \code{derivln}: the derivatives of the log-transformed CDF with respect to v,
#'     \item \code{call}: the function call.
#'   }
#' @examples
#' dvWienerCDF(t = 1.2, response = "upper", a = 1.1, v = 13, w = .6, precision = NULL, K = NULL)
#' @author Raphael Hartmann
#' @useDynLib "WienR", .registration=TRUE
#' @export
dvWienerCDF <- function(t,
                        response,
                        a,
                        v,
                        w,
