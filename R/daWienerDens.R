...
#' Partial derivative of the Wiener diffusion probability density function with respect to the upper barrier
#' 
#' Calculate the partial derivative of the Wiener diffusion probability density function with respect to the upper barrier a.
