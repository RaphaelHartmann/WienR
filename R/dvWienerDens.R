...
#' Partial derivative of the Wiener diffusion probability density function with respect to the drift rate
#' 
#' Calculate the partial derivative of the Wiener diffusion probability density function with respect to the drift rate v.
...
#'   }
#' @examples 
#' dvWienerPDF(t = 1.2, response = "upper", a = 1.1, v = 13, w = .6, precision = NULL, K = NULL)
#' @author Raphael Hartmann
#' @useDynLib "WienR", .registration=TRUE
#' @export
dvWienerPDF <- function(t,
                        response,
                        a,
                        v,
                        w,
