...
#'
#' Calculate the partial derivative of the first-passage time cumulative distribution function of the diffusion model with respect to the upper barrier a.
