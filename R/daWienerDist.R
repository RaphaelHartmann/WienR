...
#' Partial derivative of the Wiener diffusion cumulative distribution function with respect to the upper barrier
#' 
#' Calculate the partial derivative of the Wiener diffusion cumulative distribution function with respect to the upper barrier a.
...
#'   \itemize{
#'     \item \code{deriv}: the derivatives of the CDF with respect to a,
#'     \item \code{derivln}: the derivatives of the log-transformed CDF with respect to a, 
