...
int int_ddiff(unsigned dim, const double *x, void *p, unsigned fdim, double *retval) {
	...
	double *valln_ptr = (params->valln_ptr);
...
int int_daddiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dadwiener(low_or_up * (t-tau), a, nu, omega, ldW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
int int_dvddiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dvdwiener(low_or_up * (t-tau), a, nu, omega, ldW, val_ptr, valln_ptr);
...
int int_dt0ddiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dtdwiener(t-tau, a, -low_or_up*nu, wn, ldW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
int int_dwddiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dwdwiener(low_or_up * (t-tau), a, nu, omega, ldW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
void ddiff(int choice, double t, int low_or_up, double a, double v, double t0, double w, double sw, double sv, double st, double myerr, int K, int epsFLAG, double *derivF, double *derivlnF) {
	...
	double *valln_ptr = &valueln;
	double errorW = myerr ? myerr*.1 : 1.e-12*.1;

	my_params params = {t, low_or_up, a, v, t0, w, sw, sv, st, errorW, K, epsFLAG, val_ptr, valln_ptr};
	...
	hcubature(1, int_ddiff, &params, dim, xmin, xmax, 0, abstol, reltol, ERROR_INDIVIDUAL, &val, &err);
	double dens = val;
	switch (choice) {
...
int int_dapdiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dapwiener(low_or_up, (t-tau), a, nu, omega, lpW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
int int_dvpdiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dvpwiener(low_or_up, (t-tau), a, nu, omega, lpW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
int int_dwpdiff(unsigned dim, const double* x, void* p, unsigned fdim, double* retval) {
	...
	if (t - tau <= 0) retval[0] = 0.0;
		...
		dwpwiener(low_or_up, (t-tau), a, nu, omega, lpW, val_ptr, valln_ptr, errorW, K, epsFLAG);
...
void pdiff(int choice, double t, int low_or_up, double a, double v, double t0, double w, double sw, double sv, double st, double myerr, int K, int epsFLAG, double *derivF, double *derivlnF) {
	...
	//	printf("%u-dim integral, tolerance = %g\n", dim, tol);
	hcubature(1, int_pdiff, &params, dim, xmin, xmax, 0, abstol, reltol, ERROR_INDIVIDUAL, &val, &err);
	double dist = val;
	switch (choice) {
